...
$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Just a sec!</strong> this is remaining time to get married.'));

        if (MD5($('#invite_code').val()) !== '123'
            && MD5($('#invite_code').val()) !== '123') {
...
// Google map
function initMap() {
    var location = {lat:17.685898391030847,lag: 75.28671629719817};
...
function initBBSRMap() {
    var la_fiesta = {lat:17.685898391030847,lag: 75.28671629719817};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
